...
def run_nlsql_query(query_str):
	...
	# Connetti al database SQLite con SQLAlchemy
	engine = create_engine('sqlite:///segnalazioni.db')
	
	# Crea il database SQL con SQLAlchemy
	sql_database = SQLDatabase(engine, include_tables=["segnalazioni"])
